...
import ergonomicVideoRoutes from "./interfaces/routes/ErgonomicVideoRoutes";
import ergonomicMoveNetRoutes from "./interfaces/routes/ErgonomicMoveNetRoutes";
import ergonomicVideoMoveNetRoutes from "./interfaces/routes/ErgonomicVideoMoveNetRoutes";
import badgeRoutes from "./interfaces/routes/BadgeRoutes";
...
app.get("/api-test", (req, res) => {
  console.log("Root route hit at", new Date());
  res.json({
    status: "healthy",
    app: "ergocheck",
...
app.use("/api/ergonomic-movenet", ergonomicMoveNetRoutes);
app.use("/api/ergonomic-video", ergonomicVideoRoutes);
app.use("/api/ergonomic-video-movenet", ergonomicVideoMoveNetRoutes);
