...
import { AwardBadgesUseCase } from "../Badges/AwardBadgesUseCase";
...
export class SubmitAnswerUseCase {
  constructor(
    ...
    private awardBadgesUseCase: AwardBadgesUseCase
  ) {}
  ...
  async execute(
    ...
    try {
      ...
      if (allAnswers.length === totalQuestions) {
        ...
        await this.awardBadgesUseCase.awardBadgesToUser(userId);
